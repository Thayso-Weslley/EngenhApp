...
class TransferenciaCalor:
    ...
    def calcular_radiacao_calor(self, emissividade: float, area: float, temperatura_superficie: float, temperatura_ambiente: float, constante_Stefan_Boltzmann: float = 5.67e-8) -> float:
